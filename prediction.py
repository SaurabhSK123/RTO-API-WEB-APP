...
def detect_plate(img):
      car_cascade = cv2.CascadeClassifier("C:\\Users\\saurabh\\Desktop\\CNN\\Indian_plates.xml")
...
def get_vehicle_info(plate_number):
    r = requests.get("http://www.regcheck.org.uk/api/reg.asmx/CheckIndia?RegistrationNumber={0}&username=saurabhsk".format(str(plate_number)[:10]))
